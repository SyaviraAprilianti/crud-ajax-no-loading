         ...
         <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <div class="input" style="margin-top: 3%">
                        <input type="radio" name="jenis_kelamin" id="jkl1" value="Laki-laki" required="true">Laki-laki
                        <input type="radio" name="jenis_kelamin" id="jkl2" value="Perempuan" required="true" style="margin-left: 10px;">Perempuan
                    </div>
                </div>
